...
std::vector<Move> King::getMovesImplementation(BoardPieceInterface const &board, int pieceRow, int pieceCol, bool attackingMoves) const {
            ...
            switch (pieceDirection) {
                ...
                case PieceDirection::SOUTH:
                    ...
                    if ((pieceRow == 0 || pieceRow == board.getNumRows() - 1) &&                                                                    // Top or bottom row
                        ...
                        moves.emplace_back(Move(board.getNumRows(), pieceRow, pieceCol, pieceRow, pieceCol - 2));
                    }
                ...
                case PieceDirection::WEST:
                    ...
                    if ((pieceCol == 0 || pieceCol == board.getNumCols() - 1) &&
                        ...
                        moves.emplace_back(Move(board.getNumRows(), pieceRow, pieceCol, pieceRow - 2, pieceCol));
                    }
